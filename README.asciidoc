...
WARNING: This release is functional, except convertAsync is not implemented.
         However the API is still experimental and is subject to (possibly radical) change.
